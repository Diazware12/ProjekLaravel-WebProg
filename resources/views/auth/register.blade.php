                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <p></p>
                                <input id="male" type="radio" name="gender" required value="male"> Male
                                <input id="female" type="radio" name="gender" required  value="female"> Female
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" cols="30" rows="3">Address</textarea>
                            </div>
                        </div>
